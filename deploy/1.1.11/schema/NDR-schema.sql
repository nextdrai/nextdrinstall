...
CREATE TABLE public.datacenters2 (
    ...
    CONSTRAINT datacenters2_hypervisor_type_check CHECK ((hypervisor_type = ANY (ARRAY['GCP'::text, 'GENERIC'::text])))
);
...
CREATE TABLE public.enrichment_audit_log (
    ...
    error_summary text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT enrichment_audit_log_call_type_check CHECK ((call_type = ANY (ARRAY['step_enrichment'::text, 'plan_summary'::text]))),
    CONSTRAINT enrichment_audit_log_status_check CHECK ((status = ANY (ARRAY['success'::text, 'parse_failed'::text, 'secret_rejected'::text, 'db_write_failed'::text, 'provider_error'::text])))
);
...
--
-- Name: recovery_plan_step_generations; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.recovery_plan_step_generations (
    ...
    approval_phases jsonb DEFAULT '[]'::jsonb NOT NULL,
...
--
-- Name: recovery_step_dependencies; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.recovery_step_dependencies (
    ...
    CONSTRAINT recovery_step_dependencies_dependency_type_check CHECK ((dependency_type = ANY (ARRAY['requires'::text, 'soft_requires'::text, 'approval_gate'::text])))
);
...
--
-- Name: recovery_plan_step_generations recovery_plan_step_generations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recovery_plan_step_generations
    ADD CONSTRAINT recovery_plan_step_generations_pkey PRIMARY KEY (id);
...
--
-- Name: recovery_step_dependencies recovery_step_dependencies_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recovery_step_dependencies
    ADD CONSTRAINT recovery_step_dependencies_pkey PRIMARY KEY (id);


--
-- Name: recovery_step_dependencies recovery_step_dependencies_step_id_depends_on_step_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recovery_step_dependencies
    ADD CONSTRAINT recovery_step_dependencies_step_id_depends_on_step_id_key UNIQUE (step_id, depends_on_step_id);
...
--
-- Name: datacenters2_project_id_notnull_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_enrichment_audit_log_generation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_enrichment_audit_log_plan; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_enrichment_audit_log_tenant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_recovery_plan_step_generations_plan_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_recovery_plan_step_generations_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rsd_depends_on; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rsd_plan_generation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rsd_step_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: recovery_steps_new trg_recovery_steps_new_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_recovery_steps_new_updated_at BEFORE UPDATE ON public.recovery_steps_new FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: enrichment_audit_log enrichment_audit_log_generation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.enrichment_audit_log
    ADD CONSTRAINT enrichment_audit_log_generation_id_fkey FOREIGN KEY (generation_id) REFERENCES public.recovery_plan_step_generations(id) ON DELETE CASCADE;


--
-- Name: enrichment_audit_log enrichment_audit_log_step_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.enrichment_audit_log
    ADD CONSTRAINT enrichment_audit_log_step_id_fkey FOREIGN KEY (step_id) REFERENCES public.recovery_steps_new(id) ON DELETE SET NULL;


--
-- Name: enrichment_audit_log enrichment_audit_log_tenant_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.enrichment_audit_log
    ADD CONSTRAINT enrichment_audit_log_tenant_user_id_fkey FOREIGN KEY (tenant_user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
...
--
-- Name: recovery_step_dependencies recovery_step_dependencies_depends_on_step_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recovery_step_dependencies
    ADD CONSTRAINT recovery_step_dependencies_depends_on_step_id_fkey FOREIGN KEY (depends_on_step_id) REFERENCES public.recovery_steps_new(id) ON DELETE CASCADE;


--
-- Name: recovery_step_dependencies recovery_step_dependencies_generation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recovery_step_dependencies
    ADD CONSTRAINT recovery_step_dependencies_generation_id_fkey FOREIGN KEY (generation_id) REFERENCES public.recovery_plan_step_generations(id) ON DELETE CASCADE;


--
-- Name: recovery_step_dependencies recovery_step_dependencies_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recovery_step_dependencies
    ADD CONSTRAINT recovery_step_dependencies_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.recovery_plans_new(id) ON DELETE CASCADE;


--
-- Name: recovery_step_dependencies recovery_step_dependencies_step_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recovery_step_dependencies
    ADD CONSTRAINT recovery_step_dependencies_step_id_fkey FOREIGN KEY (step_id) REFERENCES public.recovery_steps_new(id) ON DELETE CASCADE;
...
--
-- Name: enrichment_audit_log Users can view own enrichment audit rows; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own enrichment audit rows" ON public.enrichment_audit_log FOR SELECT USING ((tenant_user_id = auth.uid()));
...
--
-- Name: recovery_plan_step_generations; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: recovery_step_dependencies; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: TABLE enrichment_audit_log; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.enrichment_audit_log TO anon;
GRANT ALL ON TABLE public.enrichment_audit_log TO authenticated;
GRANT ALL ON TABLE public.enrichment_audit_log TO service_role;
...
--
-- Name: TABLE recovery_plan_step_generations; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.recovery_plan_step_generations TO anon;
GRANT ALL ON TABLE public.recovery_plan_step_generations TO authenticated;
GRANT ALL ON TABLE public.recovery_plan_step_generations TO service_role;
...
--
-- Name: TABLE recovery_step_dependencies; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.recovery_step_dependencies TO anon;
GRANT ALL ON TABLE public.recovery_step_dependencies TO authenticated;
GRANT ALL ON TABLE public.recovery_step_dependencies TO service_role;
